...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
    ...
    _gsScope._gsDefine("utils.Draggable", ["events.EventDispatcher", "TweenLite"], function (t, e) {
        var i, s, r, n, a, o = {css: {}}, h = {css: {}}, l = {css: {}}, u = {css: {}}, _ = {}, c = document, p = c.documentElement || {}, f = [], d = function () {
            ...
            }, y = !c.addEventListener && c.all, T = [], w = {}, x = 0, b = /^(?:a|input|textarea|button|select)$/i, P = 0, S = 0, C = function (t) {
            ...
            e.to(D, 0, {overwrite: "all", delay: 15, onComplete: D})
        }, D = function () {
            ...
            var s = t.style;
            s && (void 0 === s[e] && (e = N(t, e)), null == i ? s.removeProperty ? s.removeProperty(e.replace(/([A-Z])/g, "-$1").toLowerCase()) : s.removeAttribute(e) : void 0 !== s[e] && (s[e] = i))
        }, X = c.defaultView ? c.defaultView.getComputedStyle : d, F = /(?:Left|Right|Width)/i, Y = /(?:\d|\-|\+|=|#|\.)*/g, U = function (t, e, i, s, r) {
            if ("px" === s || !s)return i;
        ...
        }, V = c.createElement("div"), G = "" !== N(V, "perspective"), H = N(V, "transformOrigin").replace(/^ms/g, "Ms").replace(/([A-Z])/g, "-$1").toLowerCase(), Q = N(V, "transform"), Z = Q.replace(/^ms/g, "Ms").replace(/([A-Z])/g, "-$1").toLowerCase(), $ = {}, K = {}, J = function () {
            if (!y) {
                var t = "http://www.w3.org/2000/svg", e = c.createElementNS(t, "svg"), i = c.createElementNS(t, "rect");
            ...
            return t.parentNode.insertBefore(J, t), t.parentNode.removeChild(t), J.style.cssText = n, J.style[Q] = "none", J.setAttribute("class", t.getAttribute("class")), e = J.getBoundingClientRect(), s = r.offsetParent, s ? (s === c.body && p && (s = p), i = s.getBoundingClientRect()) : i = {
                top: -M(),
                left: -L()
            ...
            var i = X(t), s = H && i ? i.getPropertyValue(H) : "50% 50%", r = s.split(" "), n = -1 !== s.indexOf("left") ? "0%" : -1 !== s.indexOf("right") ? "100%" : r[0], a = -1 !== s.indexOf("top") ? "0%" : -1 !== s.indexOf("bottom") ? "100%" : r[1];
            ...
            for (var i, s, r, n, a, o, h, l, u = ee(t, $), _ = ee(t.parentNode, K), c = ie(t, u, _); (t = t.parentNode) && t.parentNode && t !== p;)u = _, _ = ee(t.parentNode, u === $ ? K : $), h = ie(t, u, _), i = c[0], s = c[1], r = c[2], n = c[3], a = c[4], o = c[5], c[0] = i * h[0] + s * h[2], c[1] = i * h[1] + s * h[3], c[2] = r * h[0] + n * h[2], c[3] = r * h[1] + n * h[3], c[4] = a * h[0] + o * h[2] + h[4], c[5] = a * h[1] + o * h[3] + h[5];
            ...
            return t === window ? (n = M(), s = L(), r = s + (p.clientWidth || t.innerWidth || c.body.clientWidth || 0), a = n + ((t.innerHeight || 0) - 20 < p.clientHeight ? p.clientHeight : t.innerHeight || c.body.clientHeight || 0)) : (i = ee(t), s = -i.x, r = s + t.offsetWidth, n = -i.y, a = n + t.offsetHeight), t === e ? {
                left: s,
                top: n,
                width: r - s,
                height: a - n
            ...
            return r
        }, le = "ontouchstart"in p && "orientation"in window, ue = function (t) {
            ...
            s = t.touches && t.touches.length > P, ce(t.target, "touchend", pe)
        }, fe = function (t) {
            s = t.touches && t.touches.length > P, _e(t.target, "touchend", pe)
            ...
            t = E(t), i = i || {};
            var s, r, n, o, h, l, u = c.createElement("div"), _ = u.style, p = t.firstChild, f = 0, d = 0, m = t.scrollTop, g = t.scrollLeft, v = t.scrollWidth, T = t.scrollHeight, w = 0, x = 0, b = 0;
            G && i.force3D !== !1 ? (h = "translate3d(", l = "px,0px)") : Q && (h = "translate(", l = "px)"), this.scrollTop = function (t, e) {
                ...
                return (n > 2 || -2 > n) && !r ? (g = t.scrollLeft, e.killTweensOf(this, !0, {
                    left: 1,
                    scrollLeft: 1
                }), this.left(-g), i.onKill && i.onKill(), void 0) : (s = -s, 0 > s ? (d = 0 | s - .5, s = 0) : s > x ? (d = 0 | s - x, s = x) : d = 0, (d || a) && (h ? this._suspendTransforms || (_[Q] = h + -d + "px," + -f + l) : _.left = -d + "px", ge && d + w >= 0 && (_.paddingRight = d + w + "px")), t.scrollLeft = 0 | s, g = t.scrollLeft, void 0)
                ...
                return (n > 2 || -2 > n) && !r ? (m = t.scrollTop, e.killTweensOf(this, !0, {
                    top: 1,
                    scrollTop: 1
                }), this.top(-m), i.onKill && i.onKill(), void 0) : (s = -s, 0 > s ? (f = 0 | s - .5, s = 0) : s > b ? (f = 0 | s - b, s = b) : f = 0, (f || a) && (h ? this._suspendTransforms || (_[Q] = h + -d + "px," + -f + l) : _.top = -f + "px"), t.scrollTop = 0 | s, m = t.scrollTop, void 0)
            ...
            var a, _, p, T, b, k, D, M, L, N, X, F, Y, U, B, V, G, H, Q, Z, $, K, J, te, ee, ie, ne = (n.type || (y ? "top,left" : "x,y")).toLowerCase(), ae = -1 !== ne.indexOf("x") || -1 !== ne.indexOf("y"), oe = -1 !== ne.indexOf("rotation"), he = ae ? "x" : "left", pe = ae ? "y" : "top", ge = -1 !== ne.indexOf("x") || -1 !== ne.indexOf("left") || "scroll" === ne, Te = -1 !== ne.indexOf("y") || -1 !== ne.indexOf("top") || "scroll" === ne, we = this, xe = C(n.trigger || n.handle || i), be = {}, Pe = 0, Se = function (t) {
                if (H) {
                ...
                var r;
                ae ? (i._gsTransform || e.set(i, {x: "+=0"}), we.y = i._gsTransform.y, we.x = i._gsTransform.x) : oe ? (i._gsTransform || e.set(i, {x: "+=0"}), we.x = we.rotation = i._gsTransform.rotation) : _ ? (we.y = _.top(), we.x = _.left()) : (we.y = parseInt(i.style.top, 10) || 0, we.x = parseInt(i.style.left, 10) || 0), !Z && !$ || s || (Z && (r = Z(we.x), r !== we.x && (we.x = r, oe && (we.rotation = r), H = !0)), $ && (r = $(we.y), r !== we.y && (we.y = r, H = !0)), H && Se(!0)), n.onThrowUpdate && !t && n.onThrowUpdate.apply(n.onThrowUpdateScope || we, n.onThrowUpdateParams || f)
            }, ke = function () {
                var t, e, s, r;
                D = !1, _ ? (_.calibrate(), we.minX = N = -_.maxScrollLeft(), we.minY = F = -_.maxScrollTop(), we.maxX = L = we.maxY = X = 0, D = !0) : n.bounds && (t = q(n.bounds, i.parentNode), oe ? (we.minX = N = t.left, we.maxX = L = t.left + t.width, we.minY = F = we.maxY = X = 0) : void 0 !== n.bounds.maxX || void 0 !== n.bounds.maxY ? (t = n.bounds, we.minX = N = t.minX, we.minY = F = t.minY, we.maxX = L = t.maxX, we.maxY = X = t.maxY) : (e = q(i, i.parentNode), we.minX = N = j(i, he) + t.left - e.left, we.minY = F = j(i, pe) + t.top - e.top, we.maxX = L = N + (t.width - e.width), we.maxY = X = F + (t.height - e.height)), N > L && (we.minX = L, we.maxX = L = N, N = we.minX), F > X && (we.minY = X, we.maxY = X = F, F = we.minY), oe && (we.minRotation = N, we.maxRotation = L), D = !0), n.liveSnap && (s = n.liveSnap === !0 ? n.snap || {} : n.liveSnap, r = s instanceof Array || "function" == typeof s, oe ? (Z = Me(r ? s : s.rotation, N, L, 1), $ = null) : (ge && (Z = Me(r ? s : s.x || s.left || s.scrollLeft, N, L, _ ? -1 : 1)), Te && ($ = Me(r ? s : s.y || s.top || s.scrollTop, F, X, _ ? -1 : 1))))
            }, Re = function (t, e) {
                var s, a, o;
                t && r ? (t === !0 && (s = n.snap || {}, a = s instanceof Array || "function" == typeof s, t = {resistance: (n.throwResistance || n.resistance || 1e3) / (oe ? 10 : 1)}, oe ? t.rotation = de(we, a ? s : s.rotation, L, N, 1, e) : (ge && (t[he] = de(we, a ? s : s.x || s.left || s.scrollLeft, L, N, _ ? -1 : 1, e || we.lockAxis && "x" === te)), Te && (t[pe] = de(we, a ? s : s.y || s.top || s.scrollTop, X, F, _ ? -1 : 1, e || we.lockAxis && "y" === te)))), we.tween = o = r.to(_ || i, {
                    throwProps: t,
                ...
                var s, r;
                if (a && !we.isPressed && t) {
                    if (ie = Oe(), we.pointerEvent = t, ue[t.type] ? (J = -1 !== t.type.indexOf("touch") ? t.currentTarget : c, _e(J, "touchend", Ee), _e(J, "touchmove", Ie), _e(J, "touchcancel", Ee), _e(c, "touchstart", fe)) : (J = null, _e(c, "mousemove", Ie)), _e(c, "mouseup", Ee), K = me(t.target) && !n.dragClickables)return _e(t.target, "change", Ee), void 0;
                    if (y ? t = I(t, !0) : !_ || t.touches && t.touches.length > P + 1 || (t.preventDefault(), t.preventManipulation && t.preventManipulation()), t.changedTouches ? (t = B = t.changedTouches[0], V = t.identifier) : t.pointerId ? V = t.pointerId : B = null, P++, R(Se), T = we.pointerY = t.pageY, p = we.pointerX = t.pageX, De(), ee && (s = p * ee[0] + T * ee[2] + ee[4], T = p * ee[1] + T * ee[3] + ee[5], p = s), we.tween && we.tween.kill(), e.killTweensOf(_ || i, !0, be), _ && e.killTweensOf(i, !0, {scrollTo: 1}), we.tween = te = null, (n.zIndexBoost || !oe && !_ && n.zIndexBoost !== !1) && (i.style.zIndex = ye.zIndex++), we.isPressed = !0, M = !(!n.onDrag && !we._listeners.drag), !oe)for (r = xe.length; --r > -1;)z(xe[r], "cursor", n.cursor || "move");
                    W(we, "press", "onPress")
                }
            }, Ie = function (t) {
                if (a && !s && we.isPressed) {
                    y ? t = I(t, !0) : (t.preventDefault(), t.preventManipulation && t.preventManipulation()), we.pointerEvent = t;
                    var e, i, r, n, o, h, l, u, _, c = t.changedTouches, f = 1 - we.dragResistance, d = 1 - we.edgeResistance;
                    if (c) {
            ...
            Q = ye.get(this.target), Q && Q.kill(), this.startDrag = function (t) {
            ...
            }, this.drag = Ie, this.endDrag = function (t) {
                Ee(t, !0)
                ...
                var e, i;
                return t && n.bounds !== t ? (n.bounds = t, we.update(!0)) : (Ce(!0), ke(), D && (e = we.x, i = we.y, D && (e > L ? e = L : N > e && (e = N), i > X ? i = X : F > i && (i = F)), (we.x !== e || we.y !== i) && (we.x = we.endX = e, oe ? we.endRotation = e : we.y = we.endY = i, H = !0, Se())), we)
            }, this.update = function (t) {
                var e = we.x, i = we.y;
                return Ae(), t ? we.applyBounds() : Ce(!0), we.isPressed && (Math.abs(e - we.x) > .01 || Math.abs(i - we.y) > .01 && !oe) && De(), we
            }, this.enable = function (t) {
                var s, o, h;
                if ("soft" !== t)for (o = xe.length; --o > -1;)h = xe[o], _e(h, "mousedown", Le), _e(h, "touchstart", Le), _e(h, "click", Ne), oe || z(h, "cursor", n.cursor || "move"), h.ondragstart = h.onselectstart = d, z(h, "userSelect", "none"), z(h, "touchCallout", "none"), z(h, "touchAction", "none");
                ...
                if ("soft" !== t) {
                    for (e = xe.length; --e > -1;)s = xe[e], s.ondragstart = s.onselectstart = null, z(s, "userSelect", "text"), z(s, "touchCallout", "default"), z(s, "MSTouchAction", "auto"), ce(s, "mousedown", Le), ce(s, "touchstart", Le), ce(s, "click", Ne);
                    J && (ce(J, "touchcancel", Ee), ce(J, "touchend", Ee), ce(J, "touchmove", Ie)), ce(c, "mouseup", Ee), ce(c, "mousemove", Ie)
                }
            ...
            }, -1 !== ne.indexOf("scroll") && (_ = this.scrollProxy = new ve(i, O({
                onKill: function () {
                    we.isPressed && Ee(null)
                }
            }, n)), i.style.overflowY = Te && !le ? "auto" : "hidden", i.style.overflowX = ge && !le ? "auto" : "hidden", i = _.content), n.force3D !== !1 && e.set(i, {force3D: !0}), oe ? be.rotation = 1 : (ge && (be[he] = 1), Te && (be[pe] = 1)), oe ? (Y = u, U = Y.css, Y.overwrite = !1) : ae && (Y = ge && Te ? o : ge ? h : l, U = Y.css, Y.overwrite = !1), this.enable()
        ...
        return ye.hitTest = function (t, e, i) {
            if (t === e)return !1;
            var s, r, n, a = we(t), o = we(e), h = o.left > a.right || o.right < a.left || o.top > a.bottom || o.bottom < a.top;
