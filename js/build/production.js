...
!function (e, t) {
    ...
    var r = function (t) {
        var n, r, a = "ScrollMagic", u = {
            ...
            if (f.version = f.constructor.version, e.each(g, function (e) {
                ...
                }), g.container = e(g.container).first(), 0 === g.container.length)throw a + " init failed.";
        ...
        return this.addScene = function (t) {
            ...
            if (t instanceof i)t.parent() === f ? f.scrollTo(t.scrollOffset()) : log(2, "scrollTo(): The supplied scene does not belong to this controller. Scroll cancelled.", t); else if ("string" === e.type(t) || s(t) || t instanceof e) {
                var n = e(t).first();
                if (n[0]) {
    ...
    r.version = "1.3.0";
    var i = function (t) {
        var i, s, l, c, u, f, g, h = {onCenter: .5, onEnter: 1, onLeave: 0}, d = "ScrollScene", p = {
            duration: 0,
            offset: 0,
            triggerElement: null,
            ...
            unknownOptionSupplied: function () {
                ...
                } else w.duration = parseFloat(w.duration), (!e.isNumeric(w.duration) || w.duration < 0) && (w.duration = p.duration)
            }, offset: function () {
            ...
            if (s && w.triggerElement) {
                for (var r = e(w.triggerElement).first(), i = s.info(), a = o(i.container), l = i.vertical ? "top" : "left"; r.parent().data("ScrollMagicPinSpacer");)r = r.parent();
                var c = o(r);
            ...
            if (l) {
                var t = e >= 0 && 1 >= e ? e : S;
                if (-1 === l.repeat())if ("DURING" === m && l.paused())l.play(); else {
        ...
        return this.parent = function () {
            ...
            return arguments.length ? (z(n, t) && (v.trigger("change", {
                what: n,
                newval: w[n]
            }), v.trigger("shift", {reason: n})), v) : e.isNumeric(w[n]) ? w[n] : h[w[n]]
            ...
            } else c && "DURING" === m && O(!0); else s.updateScene(v, !1);
            return v
    ...
    return function (e) {
        ...
        for (t = 0; !l && t < r.length; ++t)l = e[r[t] + "RequestAnimationFrame"], c = e[r[t] + "CancelAnimationFrame"] || e[r[t] + "CancelRequestAnimationFrame"];
        l || (l = function (t) {
...
})(jQuery, window, document);;function isTouch() {
